...
const ResellersTab = ({ resellers, zones, addReseller, updateReseller, deleteReseller }) => {
    ...
    const [formData, setFormData] = useState({ name: '', zone_id: '', email: '' });
    ...
    const handleEdit = (reseller) => {
        setFormData({ name: reseller.name, zone_id: reseller.zone_id || '', email: reseller.email || '' });
    ...
    const resetForm = () => {
        setFormData({ name: '', zone_id: '', email: '' });
        setEditingId(null);
        setIsAdding(false);
    };
