...
const ChristmasHistoryModal = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            ...
            >
                {/* Header */}
                <div className="bg-[#0F4C25] text-white p-6 flex justify-between items-center shadow-md shrink-0">
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-2xl">🎄</span>
                            <h2 className="text-2xl font-bold tracking-tight">Christmas Order History</h2>
                        </div>
                ...
                <div className="p-6 bg-gray-50 border-b border-gray-200 shrink-0">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        ...
                        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <div className="text-2xl font-bold text-[#D42426]">₱{totalRevenue.toLocaleString()}</div>
                        </div>
                        <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                            <h3 className="text-gray-500 text-xs uppercase font-bold tracking-wider mb-1">Total Orders</h3>
                            <div className="text-2xl font-bold text-[#0F4C25]">{totalOrders}</div>
                        </div>
                        {/* Search Bar */}
                        <div className="lg:col-span-2 flex items-center">
                            <div className="relative w-full">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-[#D42426] focus:ring-2 focus:ring-[#D42426]/20 outline-none transition-all"
                                    value={searchTerm}
                            ...
                            {filteredOrders.length === 0 ? (
                                ...
                                filteredOrders.map(order => (
                                    <tr key={order.id} className="hover:bg-gray-50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4 text-right font-bold text-[#D42426]">
