    ...
    return (
        <div className="fade-in h-[100dvh] md:h-screen flex flex-col bg-[#0F4C25] overflow-hidden relative font-sans">
            ...
            <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
                ...
                {/* RIGHT: Cart Sidebar */}
                <div className={`fixed bottom-0 left-0 right-0 md:static w-full md:w-[560px] z-50 flex flex-col transition-all duration-300 ease-in-out ${isCartExpanded ? 'h-[75vh]' : 'h-auto'} md:h-full p-3 md:py-4 md:pr-4 md:pl-0 pb-32 md:pb-4 pointer-events-none md:pointer-events-auto`}>
