...
export const InventoryProvider = ({ children }) => {
    ...
    const [kikiksLocations, setKikiksLocations] = useState(['SM Sorsogon', 'SM Legazpi', 'Ayala Legazpi', 'SM Daet', 'Namito SM Daet', 'Namito SM Naga', 'Namito Legazpi']); // Removed Legazpi Storage
